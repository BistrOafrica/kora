    ...
    <div className="rounded-lg border bg-white dark:bg-card">
      <div className="flex items-center justify-between px-6 py-4 border-b bg-muted/10">
        ...
        <div className="flex gap-2">
          <Button variant="outline" size="sm" onClick={() => onAction('print', doc)}><Printer className="h-4 w-4 mr-1" />Print</Button>
          <Button variant="outline" size="sm" onClick={() => onAction('share', doc)}><Share2 className="h-4 w-4 mr-1" />Share</Button>
        </div>
      </div>
